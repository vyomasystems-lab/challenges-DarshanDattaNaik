...
-  checking the outputs of all vedic4x4 modules present in the vedic8x8 one by one.
-  based on the errors obtained in step(1) all the individual vedic2x2 modules within one vedic4x4 module are checked
-  based on the errors obtained in step(2) the functionality vedic2x2 module is verfied
-  The vedic2x2 module gives error indicating presence of bug in it.
